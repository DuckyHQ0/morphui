	...
	],
	{
		...
		compoundVariants: [
			...
			},
			{
				...
				varientType: "outline",
				className: [
					"bg-transparent border-brand-blue/25 text-text-1",
					"enabled:hover:bg-brand-blue/[.15] enabled:active:bg-brand-blue/5 enabled:active:border",
					"disabled:bg-transparent disabled:border-brand-blue/10",
				],
			},
			// Secondary
			{
			...
			},
			{
				...
				varientType: "outline",
				className: [
					"bg-transparent border-white/5 text-text-1",
					"enabled:hover:bg-white/[.03] enabled:active:bg-white/[.02]",
					"disabled:bg-transparent disabled:border-white/[.03]",
				],
			},
			// Success / Green
			{
			...
			},
			{
				...
				varientType: "outline",
				className: [
					"bg-transparent border-green/25 text-text-1",
					"enabled:hover:bg-green/[.14] enabled:active:bg-green/[.08]",
					"disabled:bg-transparent disabled:border-green/5",
				],
			},
			// Warning / Yellow
			{
			...
			},
			{
				...
				varientType: "outline",
				className: [
					"bg-transparent border-yellow/25 text-text-1",
					"enabled:hover:bg-yellow/[.14] enabled:hover:border-yellow/25 enabled:active:bg-yellow/[.07] enabled:active:border-yellow/25",
					"disabled:bg-transparent disabled:border-yellow/5",
				],
			},
			// Danger / Red
			{
			...
			},
			{
				...
				varientType: "outline",
				className: [
					"bg-transparent border-red/[.28] text-text-1",
					"enabled:hover:bg-red/[.15] enabled:active:bg-red/10",
					"disabled:bg-transparent disabled:border-red/10",
				],
			},
		],
		defaultVariants: {
